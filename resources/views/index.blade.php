						...
						<div class="container clearfix">
							<div class="row">
								<div class="main-header-inner">
									<div class="nav-logo">
                                    <a href="{{route('page.Home')}}"><img src="assets/images/logo.png" alt="" title="Fast Food"></a>
									...
									<div class="navMobile-navigation">
										...
										<a href="{{route('page.Home')}}"><img class="header-logo-image" src="assets/images/logo.png" alt="" title="Fast Food" /></a>
										</div>
		...
		<div id="shopify-section-theme-footer" class="shopify-section">
			...
			<section class="copy-right clearfix">
				<div class="copy-right-wrapper">
					...
					<div class="footer_copyright">Copyright &copy; 2020 <a href="{{route('page.Home')}}" title="">Fast Food</a>. All Rights Reserved</div>
					</div>
				</div>
			</section>
		</div>
